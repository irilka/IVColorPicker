#
#  Be sure to run `pod spec lint IZColorPicker.podspec' to ensure this is a
...
DESC
  ...
  s.author             = { "Irina Vaara" => "@irrillka@gmail.com" }
  # Or just: s.author    = "Irina Vaara"
  # s.authors            = { "Irina Vaara" => "" }
  # s.social_media_url   = "http://twitter.com/Irina Zavilkina"
